---
{"dg-publish":true,"permalink":"/notion/class/proof/change-of-basis-theorem/"}
---
...
我们的目标是找到 $Ã_\Phi$。根据定义 $(* *)$，$Ã_\Phi$ 是连接 $[\mathbf{v}]_{B̃}$ 和 $[\Phi(\mathbf{v})]_{C̃}$ 的桥梁。我们将利用已知的关系，通过一条“绕行”的路径来建立这个连接。这个路径就是你描述的 $B̃ \to B \to C \to C̃$。
