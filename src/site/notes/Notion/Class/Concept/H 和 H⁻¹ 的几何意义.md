---
{"dg-publish":true,"permalink":"/notion/class/concept/h-h/"}
---
...
1.  **梯度 `-g`**: 这是**最速下降方向**。在我们的等高线椭球上，这个方向**垂直于**当前点的切线。**重要：它并不指向椭球的中心！** （除非椭球是正圆形）
    ...
    *(上图中，红色箭头是负梯度 `-g` 方向，它垂直于等高线，但没有指向椭球中心。蓝色箭头是牛顿方向 `-H⁻¹g`，它直接指向了椭球（二次近似函数的最小值点）的中心。)*
...
3.  **最终结果 `-H⁻¹g` (牛顿方向)**:
    *   经过 `H⁻¹` 修正后得到的新方向，**神奇地、精确地指向了我们二次近似的那个椭球的中心点！**
