---
{"dg-publish":true,"permalink":"/wiki/notion/class/concept/the-optimization-method-using-the-second-order-derivative/"}
---
...
4.  **顾问委员会提交最终行动方案 (计算 `Δθ = -H⁻¹g`)**:
	* [[Wiki/Notion/Class/Concept/H 和 H⁻¹ 的几何意义\|H 和 H⁻¹ 的几何意义]]
