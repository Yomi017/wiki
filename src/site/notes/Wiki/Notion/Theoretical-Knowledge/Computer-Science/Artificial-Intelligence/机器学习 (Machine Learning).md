---
{"dg-publish":true,"permalink":"/wiki/notion/theoretical-knowledge/computer-science/artificial-intelligence/machine-learning/"}
---
...
1.  **监督学习 (Supervised Learning)**
    ...
    *   **子类型**:
        *   **回归 (Regression)**:
            ...
            *   **例子**: 预测房价、股票价格、温度。
        ![Image/Computer-Science/Machine Learning/1.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/1.png)
        *   **分类 (Classification)**:
            *   **目标输出**: 离散的类别标签 (a discrete class label) from a predefined set.
            *   **例子**: 图像识别（猫/狗）、邮件分类（垃圾/非垃圾）、疾病诊断（有病/无病）。![Image/Computer-Science/Machine Learning/2.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/2.png)
            ![3.jpg](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/3.jpg)
...
![Image/Computer-Science/Machine Learning/4.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/4.png) *(图示：损失值如何随着参数变化而变化，目标是找到曲面的最低点)*
...
![20.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/20.png)
...
![21.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/21.png)
...
[[Wiki/Notion/Theoretical-Knowledge/Computer-Science/Artificial-Intelligence/Question/为什么使用了验证集后，模型依然可能过拟合？ (Why may the model still overfit after using the validation set)\|为什么使用了验证集后，模型依然可能过拟合？ (Why may the model still overfit after using the validation set)]]
...
![22.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/22.png)
...
[[Wiki/Notion/Theoretical-Knowledge/Computer-Science/Artificial-Intelligence/Question/和霍夫丁不等式相关的过拟合原因 (The reasons for overfitting related to Hofding's inequality)\|和霍夫丁不等式相关的过拟合原因 (The reasons for overfitting related to Hofding's inequality)]]
...
3.  **确定更新量 (Determine Update Amount)**:
    *   $\eta$ (eta) 代表**学习率 (Learning Rate)**，它是一个[[Wiki/Notion/Theoretical-Knowledge/Computer-Science/Artificial-Intelligence/Concept/超参数 (Hyperparameters)\|超参数 (Hyperparameters)]]，控制每次参数更新的步长。
...
*   **用 Sigmoid 函数构建分段线性模型 (Building Piecewise Linear Models with Sigmoid Functions):**
    ...
    *   **激活函数的角色**: [[Wiki/Notion/Theoretical-Knowledge/Computer-Science/Artificial-Intelligence/深度学习 (Deep Learning)#^c0241b\|深度学习 (Deep Learning)#^c0241b]] 
...
*   **引入神经网络的表示方法 (Introducing Neural Network Notation):**
    ...
    *   ![Image/Computer-Science/Machine Learning/7.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/7.png)
...
![Image/Computer-Science/Machine Learning/8.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/8.png)
...
*   **使用 Mini-batch 计算损失 (Calculating Loss using Mini-batches):**
    在实际训练深度神经网络时，由于训练数据集通常非常大，一次性计算整个数据集上的损失 $L(\theta)$ 可能会非常耗时且占用大量内存。因此，我们通常采用 **Mini-batch 梯度下降** [[Wiki/Notion/Theoretical-Knowledge/Computer-Science/Artificial-Intelligence/深度学习 (Deep Learning)#2.1. Mini-batch 梯度下降 (Mini-batch Gradient Descent)\|深度学习 (Deep Learning)#2.1. Mini-batch 梯度下降 (Mini-batch Gradient Descent)]]。
...
![19.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/19.png)
...
2.  **迭代更新 (Iteratively Update):** 重复以下操作直到满足停止条件：
    *   a. **计算梯度 (Compute Gradient)**:
        ...
        *   当使用 mini-batch 时，计算的是 $L_{batch}(\theta)$ 的梯度。
           ![Image/Computer-Science/Machine Learning/9.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/9.png) 
        * (图示：梯度指向函数增加最快的方向)
...
![Image/Computer-Science/Machine Learning/10.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/10.png)
...
*   **核心思想**: 模拟物理惯性。参数的更新方向不仅取决于当前梯度，还受**历史累积的更新方向**影响。
    ![Image/Computer-Science/Machine Learning/16.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/16.png)
...
![Image/Computer-Science/Machine Learning/13.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/13.png)
...
![14.jpg](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/14.jpg)
...
![Image/Computer-Science/Machine Learning/15.jpg](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/15.jpg)
...
![Image/Computer-Science/Machine Learning/11.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/11.png)
...
[[Wiki/Notion/Theoretical-Knowledge/Computer-Science/Artificial-Intelligence/Question/Deep 而非 Fat 的 Neural Network\|Deep 而非 Fat 的 Neural Network]]
**2. 为什么我们不 "Deeper" ?**
[[Wiki/Notion/Theoretical-Knowledge/Computer-Science/Artificial-Intelligence/Question/不一直 Deeper 的神经网络\|不一直 Deeper 的神经网络]]
...
**核心思想：不同的参数需要不同的学习率。**
![Image/Computer-Science/Machine Learning/17.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/17.png)
...
![Image/Computer-Science/Machine Learning/18.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/18.png)
**总结**:
