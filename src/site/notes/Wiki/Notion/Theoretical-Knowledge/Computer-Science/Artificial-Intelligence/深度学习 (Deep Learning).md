...
![23.png](/img/user/Wiki/Image/Computer-Science/Machine%20Learning/23.png)
...
![Image/Computer-Science/Deep Learning/5.png](/img/user/Wiki/Image/Computer-Science/Deep%20Learning/5.png)
...
2.  **判别器 (Discriminator, D):**
    ...
    *   **工作流程**: ![Image/Computer-Science/Deep Learning/6.png](/img/user/Wiki/Image/Computer-Science/Deep%20Learning/6.png)
...
![Image/Computer-Science/Deep Learning/7.png](/img/user/Wiki/Image/Computer-Science/Deep%20Learning/7.png)
...
**第一步：训练判别器 D (固定 G)**
![Image/Computer-Science/Deep Learning/8.png](/img/user/Wiki/Image/Computer-Science/Deep%20Learning/8.png)
...
**第二步：训练生成器 G (固定 D)**
![Image/Computer-Science/Deep Learning/9.png](/img/user/Wiki/Image/Computer-Science/Deep%20Learning/9.png)
1.  生成新的一批**伪造图片** $G(z)$。
...
![Image/Computer-Science/Deep Learning/10.png](/img/user/Wiki/Image/Computer-Science/Deep%20Learning/10.png)
重复以上两个步骤，直到模型收敛。

## 3.4 代价函数 (Cost Function)

在深入研究GAN具体的数学公式之前，我们首先要理解它的**根本目标 (Our Objective)**。
![Image/Computer-Science/Deep Learning/11.png](/img/user/Wiki/Image/Computer-Science/Deep%20Learning/11.png)
